...
//below line from https://github.com/VoxelSrv/voxelsrv by Patbox
...
export function initRegistration(noa) {
    ...
    noa.registry.registerMaterial("grassTop", null, "grass_block_top.png", false);
    noa.registry.registerMaterial("grassSide", null, "grass_block_side.png", false);
    noa.registry.registerMaterial("dirt", null, "dirt.png", false);
    noa.registry.registerMaterial("water", null, "water_overlay.png", false);
    noa.registry.registerMaterial("grass", null, "grass.png", true);
    ...
    blockIDs.grassTopID = noa.registry.registerBlock(_id++, {material: 'grassTop'});
    ...
    blockIDs.grassID = noa.registry.registerBlock(_id++, { material: ['grassTop', 'dirt', 'grassSide'] })
    ...
    //below func modified From https://github.com/VoxelSrv/voxelsrv by Patbox
    var makePlant = (imgURLName) => {
        var testMat = noa.rendering.makeStandardMaterial('')
        testMat.backFaceCulling = false
        testMat.diffuseTexture = new Texture('textures/' + imgURLName + '.png',  scene, true, true, BABYLON.Texture.NEAREST_SAMPLINGMODE)
        testMat.diffuseTexture.hasAlpha = true
        window.t = testMat
        var testMesh = Mesh.CreatePlane('cross:' + s, 1, scene)
        testMesh.material = testMat
    ...
    blockIDs.grassPlantID = noa.registry.registerBlock(_id++, {
        blockMesh: makePlant('grass'),
        opaque: false,
    })
